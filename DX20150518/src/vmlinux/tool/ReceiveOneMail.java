...
public class ReceiveOneMail
{
	 ...
	 * 获得邮件发送日期
	 */
	public String getSentDateStr() throws Exception
	{
	...
	{
		Date recvdate = mimeMessage.getReceivedDate();
		return recvdate;
	}
	...
	public String getBodyText()
	{
		...
		if(isHtml && bodyhtml.length()>0)
		{
			String str=bodyhtml.toString();
			return str.replaceAll("<[sS][tT][yY][lL][eE][^<]+</[sS][tT][yY][lL][eE]>", "").replaceAll("<[bB][rR]>", "\r\n").replaceAll("<[^>]+>", "");
		}
		return bodytext.toString();
	}
	...
	public static void main(String args[]) throws Exception
	{
		...
		URLName urln = new URLName("pop3", "pop3.189.cn", 110, null,
				"user@189.cn", "pwd");
