...
public class RequestSource extends XObjectSourceBase
{
	...
	public static Object buildObject(HttpServletRequest request, Class xclass)
	{
		...
		RequestSource source=new RequestSource(request);
		try
		{
	...
	public RequestSource(HttpServletRequest request)
	{
		this.source=request;
		this.prefix="";
	}
	protected RequestSource(String prefix,HttpServletRequest request)
	{
		this.source=request;
		this.prefix=prefix;
	}
			...
			throws IllegalAccessException, InstantiationException
	{
		...
		while(e.hasMoreElements())
		{
			...
			{
				XObjectSource src=new RequestSource(oprefix,source);
