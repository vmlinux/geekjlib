...
public class ExcelSource extends XObjectSourceBase
{
	public static Object buildObject(ExcelReader request, String xclass)
	{
		try
		{
	...
	public static Object buildObject(ExcelReader request, Class xclass)
	{
		XObjectBuilder builder=new XObjectBuilder();
		ExcelSource source=new ExcelSource(request);
		try
		{
	...
	protected ExcelReader source;
	protected String prefix;
	
	public ExcelSource(ExcelReader request)
	{
		this.source=request;
		this.prefix="";
	}
	protected ExcelSource(String prefix,ExcelReader request)
	{
		this.source=request;
		this.prefix=prefix;
	}
			...
			throws IllegalAccessException, InstantiationException
	{
		...
		for(int i=0;i<n;++i)
		{
			...
			{
				XObjectSource src=new ExcelSource(oprefix,source);
